...
class QtActivityLoader(private val activity: QtActivity) : QtLoader(activity, QtActivity::class.java) {
    override fun loaderClassName(): String {
        return "org.qtproject.qt5.android.QtActivityDelegate"
    }

    override fun contextClassName(): Class<*> {
